...
export const SheetsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="currentColor">
        <path d="M3 3H10V10H3V3M11 3H18V10H11V3M3 11H10V18H3V11M11 11H18V18H11V11M13 13V16H16V13H13M13 5V8H16V5H13M5 5V8H8V5H5M5 13V16H8V13H5Z" />
    </svg>
);
...
export const LogoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M12 2L2 7V17L12 22L22 17V7L12 2ZM12 4.44L19.36 9L12 13.56L4.64 9L12 4.44ZM3.5 9.94L11 14.77V20.2L3.5 15.86V9.94ZM20.5 9.94V15.86L13 20.2V14.77L20.5 9.94Z"/>
    </svg>
);
...
// FIX: Corrected the ForumIcon SVG component syntax.
// The previous version had malformed JSX, causing multiple compilation errors.
// This has been replaced with a syntactically correct SVG definition.
export const ForumIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
